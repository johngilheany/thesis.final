...
``` {r, fig.cap = "The change in weight for the top 5 holdings in the US Equal Weight index\\label{fig:plot5}", fig.height=2.8, fig.width=6.5, echo=FALSE}
plot(holdings1)
```
...
``` {r fig.cap = "The change in weight for the top 5 holdings in the Minimum Volatility index\\label{fig:plot6}", fig.height=2.8, fig.width=6.5, echo=FALSE}
plot(holdings2)
```
