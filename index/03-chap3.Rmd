...
``` {r fig.cap = "Weight of consumer discretionary stocks by index over time\\label{fig:sector4}", fig.height=3.5, fig.width=6.5, echo=FALSE}
plot(cons1)
```
...
``` {r fig.cap = "Weight of healthcare stocks by index over time\\label{fig:sector5}", fig.height=3.5, fig.width=6.5, echo=FALSE}
plot(healthcare1)
```
...
``` {r fig.cap = "Weight of industrials stocks by index over time\\label{fig:sector6}", fig.height=3.5, fig.width=6.5, echo=FALSE}
plot(industrials1)
```
...
``` {r fig.cap = "Weight of information technology stocks by index over time\\label{fig:sector7}", fig.height=3.5, fig.width=6.5, echo=FALSE}
plot(infotech1)
```
...
``` {r fig.cap = "Weight of materials stocks by index over time\\label{fig:sector8}", fig.height=3.5, fig.width=6.5, echo=FALSE}
plot(materials1)
```
...
``` {r fig.cap = "Weight of utilities stocks by index over time\\label{fig:sector9}", fig.height=3.5, fig.width=6.5, echo=FALSE}
plot(utilities1)
```
