...
```{r fig.cap = "Average Weight of Top 5 Holdings in US Equal Weight Index over Time", echo=FALSE}
...
```{r fig.cap = "Average Weight of Top 5 Holdings in Minimum Volatility Index over Time", echo=FALSE}
