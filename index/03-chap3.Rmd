...
``` {r topholdingsusa, fig.cap = paste("Average Weight of Top 5 Holdings in the US Equal Weight Index over time"), echo=FALSE}
plot(holdings1)
```
\clearpage 

Shown in figure \ref{topholdingsusa} is the average weight of the top five holdings in the US Equal Weight index. The 5 largest holdings are AAPLE, XOM, MSFT, GE, and JNJ. The weights of the 5 companies start off very high, each as a few percent of the overall index, then suddenly all drop significantly to a fraction of a percent after 2015-08-31. After verifying this with iShares and MSCI, it was discovered that this due to change in the weighting mechanism.
