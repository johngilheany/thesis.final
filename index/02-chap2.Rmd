...
``` {r fig.cap = "The weights of the constructed US Equal Weight Index by month\\label{fig:plot1}", echo=FALSE}
plot(weight_plot1)
```
...
``` {r fig.cap = "The weights of the constructed Minimum Volatility Index by month\\label{fig:plot2}", echo=FALSE}
plot(weight_plot2)
```
...
``` {r fig.cap = "Correlations between the constructed US Equal Weight Index monthly returns and EUSA ETF monthly returns\\label{fig:plot3}", fig.height=4, fig.width=6.5, echo=FALSE}
plot(scatter1)
```
...
``` {r fig.cap = "Correlations between the constructed Minimum Volatility Index monthly returns and USMV ETF monthly returns\\label{fig:plot4}", fig.height=4, fig.width=6.5, echo=FALSE}
plot(scatter2)
```
