...
In this portion, the Low-Risk Anomaly will be introduced, and some
arbitrage opportunities that take advantage of it will be analyzed.

\subsection{Low-Risk Anomaly}\label{low-risk-anomaly}

In this section the Low-Risk Anomaly will be discussed in detail. This
challenges a widely regarded financial principle that investing in
higher-risk stocks will generally result in higher expected return.
Portfolios of high-risk stocks and low-risk stocks were constructed and
rebalanced regularly to reflect these characteristics, and the low-risk
portfolios outperformed the high-risk portfolios by a factor of several
times, over long-periods of time including 1929-2015 and 1968-2008. This
may raise the question why people do not just invest in low-risk stocks
then, since they are inherently safer and return more.
