...
Shown below in Figure \ref{fig:plot7} are the sector weights over time
for energy stocks. The weighting of energy stocks in the US Equal Weight
index is consistently greater than the weighting of energy stocks in the
Minimum Volatility index. This could imply that by nature, energy stocks
are more volatile than stocks in other industries.
\begin{figure}[htbp]
\centering
...
time\label{fig:plot7}}
\end{figure}
\clearpage
Shown below in Figure \ref{fig:plot8} are the sector weights over time
for financial stocks. The weighting of financial stocks in the US Equal
Weight Index is fairly consistent, until a significant drop towards the
latter half of 2016. This timing coincides with the Federal Reserve's
decision to hike rates for just the second time in a decade, amid
positive economic signs (Cox, 2016). In the Minimum Volatility Index,
the weighting of financials fluctuate quite a bit, and experience a
similar drop in weight at that same point in time.
\begin{figure}[htbp]
\centering
...
over time\label{fig:plot8}}
\end{figure}
\newline
Shown below in Figure \ref{fig:plot9} are the sector weights over time
for consumer staple stocks. The weighting of consumer staples in the US
Equal Weight Index is consistently lower than the weighting of consumer
staples in the Minimum Volatility Index. This could imply that consumer
...
index over time\label{fig:plot9}}
\end{figure}
\clearpage
Shown below in Figure \ref{fig:plot7} are the sector weights over time
for energy stocks.
...
\includegraphics{thesis_files/figure-latex/unnamed-chunk-68-1.pdf}
\hfill\break
