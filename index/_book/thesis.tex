...
{\centering \includegraphics{thesis_files/figure-latex/unnamed-chunk-74-1} 

}

\caption{ROC Curve for Logistic Regression Model}\label{fig:unnamed-chunk-74}
\end{figure}
\hfill\break
...
\caption{\label{tab:unnamed-chunk-75}Regression Model Confusion Matrix}\\
\toprule
  & 0 & 1\\
\midrule
0 & 3155 & 57\\
