...
also like to thank Professor Mark Glickman for looking at my logistic
regression model and offering suggestions on improving it, and to my
friends and family for helping proofread my thesis.
}
...
Shown in figure \ref{topholdingsusa} is the average weight of the top
five holdings in the US Equal Weight index. The 5 largest holdings are
AAPLE, XOM, MSFT, GE, and JNJ. The weights of the 5 companies start off
very high, each as a few percent of the overall index, then suddenly all
drop significantly to a fraction of a percent after 2015-08-31. After
verifying this with iShares and MSCI, it was discovered that this due to
change in the weighting mechanism.
...
\caption{\label{fig:unnamed-chunk-44}The weight of materials is consistenty
...
(annual) trailing volatility was calculated, and a month end spagetti
...
\end{Highlighting}
\end{Shaded}
\includegraphics{thesis_files/figure-latex/unnamed-chunk-61-1.pdf}
\hfill\break
